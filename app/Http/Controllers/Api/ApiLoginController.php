    ...
    public function submitAbsenceRequest(Request $request)
    {
        try {
            ...
            if($check_schedule != "OFF"){
                return response()->json(['message' => 'Anda Tidak Bisa Mengajukan Schedule Karena Pada Tanggal '.date('d F Y',strtotime($request->input('tanggal'))).' Karena Schedule Off'], 200);
            }

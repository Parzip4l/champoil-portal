    ...
    <div class="col-md-12">
        ...
        <div class="card custom-card2">
            <div class="card-header mb-3">
                ...
                @endphp
                <h5>Payroll Periode {{ \Carbon\Carbon::parse($dateParts[1])->format('j F Y') }}</h5>
            </div>
            <div class="card-body">
                    ...
                    <tbody>
                        ...
                        @foreach ($datans as $payslip)
                            <tr>
                                ...
                                <td>
                                    @if ($employee)
                                        <a href="{{ route('editns.payroldata', $payslip->id) }}">{{ $employee->nama }}</a>
                                    @else
                                        Employee not found
                                    @endif
                                </td>
                                ...
                                <td>
                                    <div class="dropdown">
                                        ...
                                        <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                                            <a class="dropdown-item d-flex align-items-center" href="{{ route('editns.payroldata', $payslip->id) }}"><i data-feather="edit-2" class="icon-sm me-2"></i> <span class="">Edit</span></a>
                                            @if ($employee)

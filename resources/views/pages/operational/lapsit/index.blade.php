  ...
  <script>
    $(document).ready(function () {
        ...
        $('#saveProjectBtn').click(() => {
            ...
            const request = id
                ? axios.put(`/api/v1/lapsit-projects-insert/${id}`, data)  // Changed to 'lapsit-projects-insert'
                : axios.post('/api/v1/lapsit-projects-insert', data);  // Changed to 'lapsit-projects-insert'
        ...
        $('#dataTable').on('click', '.edit-btn', function () {
            ...
            axios.get(`/api/v1/lapsit-projects/${id}`)  // Changed to 'lapsit-projects/{id}'
                .then(response => {
        ...
        $('#dataTable').on('click', '.delete-btn', function () {
            ...
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    axios.delete(`/api/v1/lapsit-projects/${id}`)  // Changed to 'lapsit-projects/{id}'
                        .then(() => {
                            table.ajax.reload();
    ...
    function downloadQr(unixCode) {
        axios.get(`/api/v1/lapsit-projects/${unixCode}/download`, { responseType: 'blob' })  // Changed to 'lapsit-projects/{unixCode}/download'
            .then(response => {
    ...
    $(document).ready(function() {
        ...
        $('#download_file_patrol').on('click', function() {
            ...
            axios.get('/api/v1/lapsit-activity-download', { params })

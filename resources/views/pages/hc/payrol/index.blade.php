    ...
    <div class="card">
      <div class="card-body">
        <div class="head-card d-flex justify-content-between mb-3">
            ...
            <a class="btn btn-primary d-flex align-items-center" href="{{route('payrol-component.create')}}"><i data-feather="plus" class="icon-sm me-2"></i> <span class="">Add Payrol Component</span></a>
        </div>
        <hr>

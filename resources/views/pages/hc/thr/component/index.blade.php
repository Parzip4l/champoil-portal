        ...
        <div class="card custom-card2">
            <div class="card-header d-flex justify-content-between">
                ...
                <div class="button-data">
                    <a href="{{route('component-data-thr.create')}}" class="btn btn-sm btn-primary">Assign Component</a>
                </div>
            </div>
            <div class="card-body">
                <div class="table-responsive">
                    <table id="dataTableExample" class="table">
                        ...
                        <tbody>
                            ...
                            <tr>
                                <td> {{ $nomor++ }} </td>
                                <td> {{ \App\Employee::where('nik', $data->employee_code)->value('nama') ?? 'Nama tidak ditemukan' }} </td>
                                ...
                                <td>
                                    <div class="dropdown">
                                        ...
                                        <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                                            <a class="dropdown-item d-flex align-items-center" href="{{ route('component-data-thr.edit', $data->id) }}">
    ...
    function showDeleteDataDialog(id) {
        Swal.fire({
            ...
            if (result.isConfirmed) {
                ...
                const deleteUrl = "{{ route('component-data-thr.destroy', ':id') }}".replace(':id', id);
                fetch(deleteUrl, {
                    method: 'DELETE',
                    headers: {

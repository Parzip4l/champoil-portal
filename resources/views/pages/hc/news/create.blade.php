        ...
        <div class="card-header">
            <div class="head-card d-flex justify-content-between">
                <div class="header-title align-self-center">
                    <h6 class="card-title align-self-center mb-0">Add News</h6>
                </div>
            </div>
        </div>
        <div class="card-body">
            <div class="form-tambah-news">
                <form action="{{route('news.store')}}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="form-group mb-2">
                        ...
                        <input type="text" class="form-control" name="excerpt" required placeholder="Deskripsi Singkat">
                    </div>
                    <div class="form-group mb-2">
                    ...
                    <div class="form-group mb-2">
                        <button class="btn btn-primary w-100" type="submit">Create News</button>
                    </div>
                </form>
            </div>
        </div>

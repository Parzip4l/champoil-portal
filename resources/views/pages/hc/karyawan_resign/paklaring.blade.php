    ...
    <table style="width: 100%; margin-bottom: 40px; text-align: center;font-size:20px;">
        <tr>
            <td>
                ...
                Hormat Saya
                <img src="https://hris.truest.co.id/images/company_logo/ttd.png" style="width: 200px;" alt="Company Logo">
                <img src="https://hris.truest.co.id/images/company_logo/stampel.png" style="width: 200px;" alt="Company Logo">
            </td>
        </tr>
    </table>
</body>

            ...
            <div class="card-header">
                <div class="row">
                    <div class="col-md-6 align-self-center">
                        <h6 class="card-title mb-0">Divisi List</h6>
                    </div>
                    <div class="col-md-6 text-right">
                        <a href="#" class="btn btn-primary" data-bs-target="#CompanyModal" data-bs-toggle="modal">Add Divisi</a>
                    </div>
                </div>
            </div>
            <div class="card-body">
    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="CompanyModal">Tambah Data Divisi</h5>
        ...
        Swal.fire({
            ...
            if (result.isConfirmed) {
                ...
                fetch(deleteUrl, {
                    ...
                    if (response.ok) {
                        Swal.fire({
                            title: 'Divisi Successfully Deleted',
                            icon: 'success',
                        }).then(() => {

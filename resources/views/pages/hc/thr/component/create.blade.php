...
<div class="row mb-4">
    <div class="topbar-wrap d-flex justify-content-between">
        <div class="arrow-back">
            <a href="{{url('component-data-thr')}}" class="d-flex color-custom">
...
<div class="row">
    <div class="col-md-12">
        <div class="card custom-card2">
            ...
            <div class="card-body">
                <form action="{{route('component-data-thr.store')}}" method="POST">
                    @csrf
                    <div class="row">
                        ...
                        <div class="col-md-6 mb-2">
                            ...
                            <input type="number" name="gaji_pokok" class="form-control allowance" required>   
                        </div>
                        @foreach($allowence as $dataallowence)
                        <div class="col-md-6 mb-2">
                            <label for="" class="form-label">{{$dataallowence->front_text}}</label>
                            <input type="number" name="allowance[{{$dataallowence->id}}][]" class="form-control allowance" required>   
                        </div>
                        @endforeach
                        <div class="title mt-2 mb-2">
                            <h5>Deduction</h5>
                        ...
                        <div class="col-md-6 mb-2">
                            <label for="" class="form-label">{{$datadeduction->front_text}}</label>
                            <input type="number" name="deduction[{{$datadeduction->id}}][]" class="form-control deduction" id="t_deduction" required>   
                        </div>
                        @endforeach
                    </div>

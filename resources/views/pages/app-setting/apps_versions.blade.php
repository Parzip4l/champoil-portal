    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form action="{{route('version-save')}}" method="POST" enctype="multipart/form-data">
                    @csrf
                    <div class="row">
                        <div class="col-md-12 mb-2">
                            <label for="" class="form-label">Android</label>
                            <input type="text" class="form-control" name="android" required>    
                        </div>
                        <div class="col-md-12 mb-2">
                            <label for="" class="form-label">IOS</label>
                            <input type="text" class="form-control" name="ios" required>    
                        </div>

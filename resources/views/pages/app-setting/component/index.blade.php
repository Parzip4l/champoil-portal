    ...
    <div class="col-md-12 grid-margin stretch-card">
        <div class="card custom-card2">
            <div class="card-header d-flex justify-content-between">
                <h5 class="mb-0 align-self-center">Additional Component</h5>
                <a href="{{route('additional-component.create')}}" class="btn btn-sm btn-primary">Assign Component</a>
            </div>
            <div class="card-body">
                <div class="table-responsive">
                    <table id="dataTableExample" class="table">
                        ...
                        <tbody>
                            ...
                            <tr>
                                <td> {{$nomor++}} </td>
                                <td><a href="{{ route('additional-component.showDetails', ['code_master' => $data->code]) }}">{{ $data->title }}</a></td>
                                <td> {{ $data->code }} </td>
                                <td> {{ $data->type }}</td>

                ...
                <form method="POST" action="{{ route('employee.store') }}" enctype="multipart/form-data">
                    ...
                    <div class="row mb-3">
                        <div class="col">
                            ...
                            <input id="name" class="form-control" name="nama" value="{{ $record['nama_lengkap'] }}" type="text" placeholder="John Doe">
                        </div>
                        <div class="col-md-6">
                            <label for="Ktp" class="form-label">KTP</label>
                            <input id="ktp" class="form-control" name="ktp" value="{{ $record['nomor_induk'] }}" type="number" placeholder="3xxxxxx">
                        </div>
                    </div>
                    <div class="row mb-3">
                        <div class="col">
                            <label for="kode_karyawan" class="form-label">Kode Karyawan</label>
                            <input id="kode_karyawan" class="form-control" name="nik" value="{{ $record['nomor_induk'] }}" type="number" placeholder="xxx-xxx-xxx">
                        </div>
                        <div class="col">
                    ...
                    <div class="row mb-3">
                        <div class="col">
                            ...
                            <input id="email" class="form-control" value="{{ $record['email_aktif'] }}" name="email" type="email" placeholder="johndoe@champoil.co.id">
                        </div>
                        <div class="col">
                    ...
                    <div class="row mb-3">
                        <div class="col">
                            ...
                            <input type="date" class="form-control" value="{{ date('Y-m-d') }}"  name="joindate">
                        </div>
                        <div class="col-md-6">
                    ...
                    <div class="row mb-3">
                        <div class="col">
                            ...
                            <input type="text" class="form-control" value="{{ $record['tempat_lahir'] }}" name="tempat_lahir" placeholder="Jakarta">
                        </div>
                        <div class="col-md-6">
                            <label class="form-label">Tanggal Lahir</label>
                            <input type="date" class="form-control" value="{{ $record['tanggal_lahir'] }}" name="tanggal_lahir">
                        </div>
                    </div>
                    <div class="row mb-3">
                        <div class="col">
                            <label class="form-label">Full Address Domisili</label>
                            <textarea name="alamat" id="" cols="30" rows="10" class=form-control>{{ $record['domisili'] }}</textarea>
                        </div>
                        <div class="col">
                            <label class="form-label">Full Address KTP</label>
                            <textarea name="alamat_ktp" id="" cols="30" rows="10" class=form-control>{{ $record['alamat_ktp'] }}</textarea>
                        </div>
                    </div>
                    <div class="row mb-3">
                        <div class="col">
                    ...
                    <div class="col-md-12 mb-2">
                        ...
                        <input type="password" class="form-control"  value="City2024!" name="password" id="passwordInput" placeholder="Password" required>
                    ...
                    <div class="mb-3">
                        ...
                        <input type="password" class="form-control" id="passwordConfirmationInput" value="City2024!" name="password_confirmation" placeholder="Konfirmasi Password" required>
                        ...
                        <div class="row">
                            <div class="col-md-4">
                                <div class="form-check">
                                    <input type="checkbox" checked class="form-check-input" name="permissions[]" value="dashboard_access">

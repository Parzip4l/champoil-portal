...
<html>
<head>
    <title>Membership Rejected</title>
    <style>
        img.companylogo {
            max-width:12%;
        }
    ...
    <table align="center" width="100%" cellspacing="0" cellpadding="0" border="0">
        <tr>
            ...
            <img src="{{ asset('assets/images/company/' . $companyLogo) }}" alt="Company Logo" class="companylogo">
                <h2>Member of Cooperative Rejected</h2>
            </td>
        </tr>
        <tr>
            <td align="center" style="padding: 20px;">
                <p>Dear {{ $employeeName }},</p>
                <p>We would like to inform you that your application as a cooperative member at TRUEST cannot be approved at this time. We apologize for the inconvenience.</p>

...
<div class="arrow-back mb-4">
    <a href="{{route('pajak.index')}}" class="d-flex color-custom">
            ...
            <div class="card-header">
                <div class="row">
                    <div class="col-md-6 align-self-center">
                        <h6 class="card-title mb-0">PPH21 Category {{$codename}}</h6>
                    </div>
                ...
                <div class="table-responsive">
                    <table id="dataTableExample" class="table">
                        <thead>
                            <tr>
                                <th>Code</th>
                                <th>Min Pengahasilan</th>
                                <th>Max Penghasilan</th>
                                <th>Persentase</th>
                                <th>Action</th>
                            </tr>
                        </thead>
                        <tbody>
                            ...
                            <tr>
                                <td>{{$codename}}</td>
                                <td>Rp. {{ number_format($data->min_bruto, 0, ',', '.') }}</td>
                                <td>Rp. {{ number_format($data->max_bruto, 0, ',', '.') }}</td>

            ...
            <div class="card-header">
                <div class="row">
                    <div class="col-md-6 align-self-center">
                        <h6 class="card-title mb-0">Organisasi List</h6>
                    </div>
                    <div class="col-md-6 text-right">
                        <a href="#" class="btn btn-primary" data-bs-target="#CompanyModal" data-bs-toggle="modal">Add Organisasi</a>
                    </div>
                </div>
            </div>
            <div class="card-body">
    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="CompanyModal">Tambah Data Organisasi</h5>
                ...
                <form action="{{route('organisasi.store')}}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="row">
                        <div class="col-md-12 mb-3">
                            <label for="" class="form-label">Organisasi Name</label>
                            <input type="text" name="name" class="form-control" placholder="" required>
                        </div>
                        <div class="col-md-12">
                            <button type="submit" class="btn btn-primary w-100 mt-2">Add Organisasi</button>
                        </div>
                    </div>
                </form>
            </div>
...
<div class="modal fade" id="CompanyModalEdit{{$data->id}}" tabindex="-1" aria-labelledby="CompanyModalEdit{{$data->id}}" aria-hidden="true">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form action="{{route('organisasi.update', $data->id)}}" method="POST" enctype="multipart/form-data">
                    @csrf
                    @method('PUT')
                    <div class="row">
                        <div class="col-md-12 mb-3">
                        ...
                        <div class="col-md-12">
                            <button type="submit" class="btn btn-primary w-100 mt-2">Update Organisasi  </button>
                        </div>
                    </div>
                </form>
            </div>
